...
- реализацию HTTP API на основе FastAPI;
- бизнес-логику создания, обновления, удаления и вычисления функций.

Модели используются для валидации входных данных и сериализации ответов в формате JSON.
